							...
							items : [{
										...
										handler : function() {
											EmpProfileSelector.getView(
													function(array) {
														Ext
																.getCmp('SalaryPayoffForm.profileNo')
																.setValue(array[1]);
														Ext
																.getCmp('SalaryPayoffForm.fullname')
																.setValue(array[2]);
														Ext
																.getCmp('SalaryPayoffForm.standAmount')
																.setValue(array[9]);
														Ext
																.getCmp('SalaryPayoffForm.idNo')
																.setValue(array[11]);
														Ext
																.getCmp('SalaryPayoffForm.userId')
																.setValue(array[12]);
